...
import com.example.solnyshkosmartlamp.di.ApplicationScope
import com.example.solnyshkosmartlamp.utils.CommandSender
...
class BleDeviceManager @Inject constructor(
    ...
    private fun setupCommandSender() {
        commandSender = CommandSender<LampCommand>(
            scope = scope,
            serializer = { command -> DataByteArray(gson.toJson(command).toByteArray(Charsets.UTF_8)) },
            writer = { data ->
