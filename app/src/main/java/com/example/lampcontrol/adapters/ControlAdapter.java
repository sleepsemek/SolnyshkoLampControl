    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Lamp lamp, OnButtonClickListener onClickListener) {
            ...
            itemView.setOnClickListener(view -> {
                onClickListener.onInstanceClicked(lamp, getAdapterPosition());
            });

            renameButton.setOnClickListener(view -> {
                onClickListener.onRenameClicked(lamp, getAdapterPosition());
            });

            deleteButton.setOnClickListener(view -> {
                onClickListener.onDeleteClicked(lamp, getAdapterPosition());
            });
